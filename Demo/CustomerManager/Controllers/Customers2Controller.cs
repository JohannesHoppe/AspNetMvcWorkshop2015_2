...
namespace CustomerManager.Controllers
{
    public class Customers2Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Mail")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Mail")] Customer customer)
        {
            if (ModelState.IsValid)
            {
